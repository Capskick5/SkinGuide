...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a leakage-safe, production-aligned MobileNetV2 skin-type model.")
    ...
    checkpoint_path = args.output_dir / "skin_type_mobilenetv2_candidate.pt"

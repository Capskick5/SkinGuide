...
class DataImportServiceTest {
    ...
    void skipsExistingProductSoRepeatedSeedDoesNotDuplicateAtlasData() {
        ...
        IDataImportService.ImportResult result = service.importProducts(List.of(product));
        assertThat(result).isEqualTo(new IDataImportService.ImportResult(0, 1, 1));
    ...
    void generatesSlugAndImportsNewProduct() {
        ...
        assertThat(result).isEqualTo(new IDataImportService.ImportResult(1, 0, 1));

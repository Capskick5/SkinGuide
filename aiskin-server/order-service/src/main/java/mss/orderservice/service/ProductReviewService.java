...
public class ProductReviewService {
    ...
    public ProductReviewSummaryResponse getProductReviews(String productId, int page, int size) {
        Page<ProductReview> reviewPage = reviewRepository.findByProductIdOrderByCreatedAtDesc(
                productId,
    ...
    public ProductReviewEligibilityResponse getEligibility(String customerId, String productId) {
        ...
        if (existing != null) {
            return ProductReviewEligibilityResponse.builder()
                    .eligible(true)
                    .reason("Bạn đã đánh giá sản phẩm này và có thể cập nhật đánh giá.")
                    .existingReview(toResponse(existing))
                    .build();
        }
        ...
        return ProductReviewEligibilityResponse.builder()
                .eligible(purchased)
                .reason(purchased
                        ? "Đơn hàng đã giao thành công. Bạn có thể đánh giá sản phẩm."
                        : "Chỉ khách đã nhận sản phẩm mới có thể đánh giá.")
                .build();
    }
    ...
    public ProductReviewResponse create(String customerId, String productId, ProductReviewRequest request) {
        ...
        ProductReview review = ProductReview.builder()
                ...
                .reviewerName(maskName(order.getCustomerName()))
    ...
    private Order findDeliveredOrder(String customerId, String productId) {
        Page<Order> deliveredOrders = orderRepository.findByCustomerIdAndStatusOrderByCreatedAtDesc(
                customerId,

...
public class DashboardService {
    ...
    public Map<String, Object> getFinancialSummary() {
        ...
        BigDecimal totalShippingRevenue = paidOrders.stream()
                .map(o -> o.getShippingFee() != null ? o.getShippingFee() : BigDecimal.ZERO)
                .reduce(BigDecimal.ZERO, BigDecimal::add);
        ...
        BigDecimal totalReturnShippingFee = completedReturns.stream()
                .map(r -> r.getReturnShippingFee() != null ? r.getReturnShippingFee() : BigDecimal.ZERO)
                .reduce(BigDecimal.ZERO, BigDecimal::add);

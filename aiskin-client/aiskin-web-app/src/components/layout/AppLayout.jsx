...
export default function AppLayout() {
  return (
    <div className="text-on-surface min-h-screen md:pl-sidebar bg-[linear-gradient(145deg,#eaf5f0_0%,#f8eee9_52%,#edf1fb_100%)]">
      <Sidebar />
      <TopNav />
      ...
      <main className="md:fixed md:top-[52px] md:left-sidebar md:right-0 md:bottom-0 px-2 pt-2 pb-20 md:p-0">
        <div className="bg-canvas/97 rounded-t-[1.25rem] shadow-[0_24px_80px_rgba(23,32,38,0.10)] ring-1 ring-white/70 min-h-[calc(100vh-72px)] md:min-h-0 md:h-full md:overflow-y-auto md:scroll-smooth scrollbar-hidden px-4 md:px-8 lg:px-12 py-7 md:py-9">
